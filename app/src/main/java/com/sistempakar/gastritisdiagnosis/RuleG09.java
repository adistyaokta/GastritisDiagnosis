...
public class RuleG09 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!gejalaList.isEmpty()) {
            Gejala firstGejala = gejalaList.get(8);
                        ...
                        if (!selectedValue.equals("Pilih tingkat keyakinan")) {
                            ...
                            for (Gejala gejala : gejalaList) {
                                ...
                                if (kodeGejala.equals("G01") || kodeGejala.equals("G02") || kodeGejala.equals("G03") ||
                                        kodeGejala.equals("G04") || kodeGejala.equals("G05") || kodeGejala.equals("G06") ||
                                        kodeGejala.equals("G07") || kodeGejala.equals("G08") || kodeGejala.equals("G09")) {
                                    selectedGejalaList.add(gejala);
                                }
                            }
                            String kodeGejala = gejalaList.get(8).getKodeGejala();

                            // Call the updateCfUser method to update the database
                            DBHelper dbHelper = new DBHelper(RuleG09.this);
                            dbHelper.updateCfUser(kodeGejala, selectedValue);

                            // Start HasilKonsul activity and pass the selected gejala list
                            Intent intent = new Intent(RuleG09.this, HasilDiagnosa.class);
        ...
        btnTidak.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Find gejala G01, G02, G03, G04, G05 & G06 from gejalaList and add them to selectedGejalaList
                for (Gejala gejala : gejalaList) {
                    String kodeGejala = gejala.getKodeGejala();
                    if (kodeGejala.equals("G01") || kodeGejala.equals("G02") || kodeGejala.equals("G03") ||
                            kodeGejala.equals("G04") || kodeGejala.equals("G05") || kodeGejala.equals("G06") || kodeGejala.equals("G07")
                            || kodeGejala.equals("G08")) {
                        selectedGejalaList.add(gejala);
                    }
                }
