...
public class RuleG13 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!gejalaList.isEmpty()) {
            Gejala firstGejala = gejalaList.get(12);
                ...
                spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                    ...
                    public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                        ...
                        if (!selectedValue.equals("Pilih tingkat keyakinan")) {
                            String kodeGejala = gejalaList.get(12).getKodeGejala();

                            // Call the updateCfUser method to update the database
                            DBHelper dbHelper = new DBHelper(RuleG13.this);
                            dbHelper.updateCfUser(kodeGejala, selectedValue);
                            Intent intent = new Intent(RuleG13.this, RuleG14.class);
        ...
        btnTidak.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for (Gejala gejala : gejalaList) {
                    ...
                    if (kodeGejala.equals("G01") || kodeGejala.equals("G10") || kodeGejala.equals("G11") || kodeGejala.equals("G12")) {
                        selectedGejalaList.add(gejala);
                    }
                }

                // Start HasilKonsul activity and pass the selected gejala list
                Intent intent = new Intent(RuleG13.this, HasilDiagnosa.class);
