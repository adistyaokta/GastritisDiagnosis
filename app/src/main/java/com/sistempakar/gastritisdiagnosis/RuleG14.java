...
public class RuleG14 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!gejalaList.isEmpty()) {
            Gejala firstGejala = gejalaList.get(13);
                ...
                spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                    ...
                    public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                        ...
                        if (!selectedValue.equals("Pilih tingkat keyakinan")) {
                            String kodeGejala = gejalaList.get(13).getKodeGejala();

                            // Call the updateCfUser method to update the database
                            DBHelper dbHelper = new DBHelper(RuleG14.this);
                            dbHelper.updateCfUser(kodeGejala, selectedValue);
                            Intent intent = new Intent(RuleG14.this, RuleG15.class);
            ...
            public void onClick(View v) {
                ...
                for (Gejala gejala : gejalaList) {
                    ...
                    if (kodeGejala.equals("G01") || kodeGejala.equals("G10") ||
                            kodeGejala.equals("G11") || kodeGejala.equals("G12") || kodeGejala.equals("G13")) {
                        selectedGejalaList.add(gejala);
                    }
                }

                // Start HasilKonsul activity and pass the selected gejala list
                Intent intent = new Intent(RuleG14.this, HasilDiagnosa.class);
