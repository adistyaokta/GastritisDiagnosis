...
public class RuleG08 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!gejalaList.isEmpty()) {
            Gejala firstGejala = gejalaList.get(7);
                ...
                spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                    ...
                    public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                        ...
                        if (!selectedValue.equals("Pilih tingkat keyakinan")) {
                            String kodeGejala = gejalaList.get(7).getKodeGejala();

                            // Call the updateCfUser method to update the database
                            DBHelper dbHelper = new DBHelper(RuleG08.this);
                            dbHelper.updateCfUser(kodeGejala, selectedValue);
                            Intent intent = new Intent(RuleG08.this, RuleG09.class);
        ...
        btnTidak.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Find gejala G01, G10, G11, G12, G13, G14, G15, and G20 from gejalaList and add them to selectedGejalaList
