...
public class RuleG07 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!gejalaList.isEmpty()) {
            Gejala firstGejala = gejalaList.get(6);
                ...
                spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                    ...
                    public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                        ...
                        if (!selectedValue.equals("Pilih tingkat keyakinan")) {
                            String kodeGejala = gejalaList.get(6).getKodeGejala();

                            // Call the updateCfUser method to update the database
                            DBHelper dbHelper = new DBHelper(RuleG07.this);
                            dbHelper.updateCfUser(kodeGejala, selectedValue);
                            Intent intent = new Intent(RuleG07.this, RuleG08.class);
        ...
        btnTidak.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(RuleG07.this, HasilDiagnosa.class);
