...
public class RuleG02 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!gejalaList.isEmpty()) {
            Gejala firstGejala = gejalaList.get(1);
                ...
                spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                    ...
                    public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                        ...
                        if (!selectedValue.equals("Pilih tingkat keyakinan")) {
                            String kodeGejala = gejalaList.get(1).getKodeGejala();

                            // Call the updateCfUser method to update the database
                            DBHelper dbHelper = new DBHelper(RuleG02.this);
                            dbHelper.updateCfUser(kodeGejala, selectedValue);

                            RuleG02.this.startActivity(new Intent(RuleG02.this, RuleG03.class));
                        }
                    }
        ...
        btnTidak.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                RuleG02.this.startActivity(new Intent(RuleG02.this, RuleG10.class));
            }
        });
    }
}
