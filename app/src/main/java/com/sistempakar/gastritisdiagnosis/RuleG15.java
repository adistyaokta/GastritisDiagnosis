...
public class RuleG15 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!gejalaList.isEmpty()) {
            Gejala firstGejala = gejalaList.get(14);
                    ...
                    public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                        ...
                        if (!selectedValue.equals("Pilih tingkat keyakinan")) {
                            for (Gejala gejala : gejalaList) {
                                ...
                                if (kodeGejala.equals("G01") || kodeGejala.equals("G10") || kodeGejala.equals("G11") ||
                                        kodeGejala.equals("G12") || kodeGejala.equals("G13") || kodeGejala.equals("G14") ||
                                        kodeGejala.equals("G15")) {
                                    selectedGejalaList.add(gejala);
                                }
                            }
                            String kodeGejala = gejalaList.get(14).getKodeGejala();

                            // Call the updateCfUser method to update the database
                            DBHelper dbHelper = new DBHelper(RuleG15.this);
                            dbHelper.updateCfUser(kodeGejala, selectedValue);

                            // Start HasilKonsul activity and pass the selected gejala list
                            Intent intent = new Intent(RuleG15.this, HasilDiagnosa.class);
        ...
        btnTidak.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for (Gejala gejala : gejalaList) {
                    String kodeGejala = gejala.getKodeGejala();
                    if (kodeGejala.equals("G01") || kodeGejala.equals("G10") ||
                            kodeGejala.equals("G11") || kodeGejala.equals("G12") || kodeGejala.equals("G13") || kodeGejala.equals("G14")) {
                        selectedGejalaList.add(gejala);
                    }
                }
